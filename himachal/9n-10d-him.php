	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(../images/banner/top-heading-himchal.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h2 class="heading_primary">9 Nights 10 Days</h2></div>
		</div>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description-tab">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Shimla (2 Nights) - Manali (3 Nights) - Dharmshala (2 Night) - Dalhousie (1 Night) - Amritsar (1 Night)</td>
											</tr>
											<tr>
...
individual basis as per guest requirement & Rohtang is closed on every Tuesday.</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 9 :  Dalhousie to Amritsar 4 h 13 min (197.7 km)</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 10 :  Amritsar to Delhi   7 h 39 min (450.6 km)</strong></h2>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											...
											<td>Per Person (INR - 33,000)</td>
											<td>Per Person (INR - 24,500)</td>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 23,500</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
									...
									<div class="custom_from">
										<div role="form" class="wpcf7" lang="en-US" dir="ltr">
											...
											<form action="9n-10d-him.php" method="post" class="wpcf7-form"><br>
