								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description-tab">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Shimla (2 Nights) - Manali (3 Nights)</td>
											</tr>
											<tr>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 4 - Manali - Solang Valley - Rohtang Pass (Optional)</strong></h2>
												<p>After breakfast, drive to Solang valley and indulge in adventurous activities like parachuting, paragliding or zorbing etc. Return to the hotel in Manali, where dinner and overnight stay facilities are arranged.</p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">5</span></p>
											<div class="item_content">
												<h2><strong>Day 5 - Manali City Tour</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 6 - Manali - Chandigarh / Delhi (Dropping)</strong></h2>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											...
											<td>Per Person (INR - 23,000)</td>
											<td>Per Person (INR - 15,500)</td>
											<td>Per Person (INR - 15,000)</td>
											<td>Per Person (INR - 16,500)</td>
										   </tr>
											<tr>    
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 15,000</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
