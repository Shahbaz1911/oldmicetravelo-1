...
<div class="wrapper-container">
	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(images/banner/top-heading-contact.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h1 class="heading_primary">Payment </h1></div>
		</div>
		<section class="content-area">
			<div class="container">
				<div class="row">
					<h1>PAYMENT  DETAILS<u></u><u></u></h1>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1"placeholder="Tour Name" aria-describedby="emailHelp">
    <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="exampleInputEmail1"placeholder="Mobile Number" aria-describedby="emailHelp">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control"placeholder="Amount"  id="exampleInputPassword1">
  </div>
...
<p>For any queries regarding our payment  you may contact us at <a href="mailto:info@micetravelo.com" target="_blank">info@micetravelo.com</a> . All enquiries relating to our services should be directed through our Contact Us page.<u></u><u></u></p>
<p><u></u> </p>
				</div>
			</div>
		</section>
