				...
				<div class="row">
					<div class="col-md-12">
						<div class="mu-video-area">
							...
							<iframe width="854" height="480" "https://www.youtube.com/embed/Y45Mb0F3bK0" allowfullscreen></iframe>            <!-- End Video content -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="mu-featured-tours-area">
							...
							<p class="mu-title-content">Take to any of these Himachal Pradesh tour packages. Get free quotes and customisable itineraries for Himachal Pradesh inclusive of sightseeing, stay and transport from Mice Travelo</p>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-1.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>3 Nights 5 Days VOLVO</h4>
												<span class="mu-price-tag">INR 11,500 Per Person</span>
												<p>Manali (3 Nights)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-2.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>4 Nights 5 Days</h4>
												<span class="mu-price-tag">INR 13,000 Per Person</span>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-3.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>5 Nights 6 Days</h4>
												<span class="mu-price-tag">INR 15,000 Per Person</span>
										...
										<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-4.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>6 Nights 7 Days</h4>
												<span class="mu-price-tag">INR 16,500 Per Person</span>
												<p>Shimla (2 Nights) - Manali (3 Nights) - Chandigarh (1 Night)<br><br></p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-5.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>7 Nights 8 Days</h4>
												<span class="mu-price-tag">INR 18,500 Per Person</span>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-6.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>8 Nights 9 Days</h4>
												<span class="mu-price-tag">INR 21,000 Per Person</span>
                                    ...
                                    <div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-7.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>9 Nights 10 Days</h4>
												<span class="mu-price-tag">INR 23,500 Per Person</span>
                                    ...
                                    <div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-8.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>10 Nights 11 Days</h4>
												<span class="mu-price-tag">INR 25,500 Per Person</span>
                                    ...
                                    <div class="col-md-4">
										<div class="mu-featured-tours-single">
											<img src="assets/images/himachal-tour/tour-9.jpg" alt="img">
											<div class="mu-featured-tours-single-info">
												<h3>Himachal Pradesh</h3>
												<h4>11 Nights 12 Days</h4>
												<span class="mu-price-tag">INR 28,000 Per Person</span>
							...
							<div class="mu-testimonials-block">
								<ul class="mu-testimonial-slide">
									...
									<li>
										...
										<p>"I travelled with my family..Very nice hospitality and cooperative nature..Staying facility is also very nice ...We enjoyed a lot at Himachal Pradesh"</p>
                                    ...
                                    <li>
										<i class="fa fa-quote-left mu-client-quote" aria-hidden="true"></i>
										<p>"Nice trip of Himachal Pradesh with mice travelo  hope to have long lasting bonding For vacation trips."</p>
									...
									<li>
										<i class="fa fa-quote-left mu-client-quote" aria-hidden="true"></i>
										<p>"It was pleasant n pocket friendly experience of Himachal Pradesh without their kind support would not have been possible.Thank you MICE TRAVELO."</p>
					...
					<div class="col-md-12">
						<div class="mu-clients-area">
							...
							<div class="mu-clients-slider">
                                ...
                                <div class="mu-clients-single">
									<img src="assets/images/uttarakhand-7.jpg" alt="Our Awesome Clients">
								</div>
                                <div class="mu-clients-single">
									<img src="assets/images/uttarakhand-8.jpg" alt="Our Awesome Clients">
								</div>
                                 <div class="mu-clients-single">
									<img src="assets/images/uttarakhand-9.jpg" alt="Our Awesome Clients">
								</div>
                                 <div class="mu-clients-single">
									<img src="assets/images/uttarakhand-10.jpg" alt="Our Awesome Clients">
								</div>
                                <div class="mu-clients-single">
									<img src="assets/images/uttarakhand-11.jpg" alt="Our Awesome Clients">
								</div>
							</div>
			...
			<div class="container">
				<div class="row col-md-12">
					<div class="mu-callto-action-area">
						<h2>Explore the Himachal Pradesh by making journey with us</h2>
