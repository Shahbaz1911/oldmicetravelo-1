...
<html lang="en">
  <head>
    ...
    <!-- Main Style -->
    <link href="style-kerala.css" rel="stylesheet"> 
    <!-- Main Style -->
  ...
  <!-- END SCROLL TOP BUTTON -->
	...
	<main>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<p>Munnar (2 Nights) - Thekkady (1 Night) - Alleppey (1 Night)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<p>Munnar (2 Nights)- Thekkady (1 Night)- Alleppey (1 Night) - Kovalam (1 Night)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<p>Munnar (2 Nights) - Thekkady (1 Night) - Alleppey (1 Night) - Kovlam (2 Night)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
									</div>
        ...
        echo "There was a problem with your submission, please try again.";
                        ...
                        <form id="contact" action="kerala.php" method="post">     
                            <fieldset>
