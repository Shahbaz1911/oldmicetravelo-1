<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email_content .= "From Himachal tour packages\n\n";
...
<html lang="en">
  <head>
    ...
    <!-- Main Style -->
    <link href="style-himachal.css" rel="stylesheet"> 
    <!-- Main Style -->
  ...
  <!-- END SCROLL TOP BUTTON -->
	...
	<main>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<span class="mu-price-tag">INR 12,999 Onwards</span>
									...
									<div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<span class="mu-price-tag">INR 13,999 Onwards</span>
												<p>Shimla (2 Nights) - Manali (2 Nights) - Dharmshala (1 Night) - Dalhousie (1 Night) - Amritsar (1 Night)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
                                    ...
                                    <div class="col-md-4">
										<div class="mu-featured-tours-single">
											...
											<div class="mu-featured-tours-single-info">
												...
												<span class="mu-price-tag">INR 14,999 Onwards</span>
												<p>Shimla (2 Nights) - Manali (2 Nights) - Dharmshala (1 Night) - Dalhousie (1 Night) - Amritsar (1 Night)</p>
												<a href="#mu-contact" class="mu-book-now-btn">Get Free Quotes</a>
											</div>
										</div>
        ...
        echo "There was a problem with your submission, please try again.";
                        ...
                        <form id="contact" action="himachal-mailer.php" method="post">     
                            <fieldset>
