							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description-tab">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Nanital (2 Nights) - Kausani (1 Night)- Jim Corbett(1 Night) - Mussoorie (2 Nights)</td>
											</tr>
											<tr>
									...
									<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 5: Jungle safari & Driver to Mussoorie</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 6: Explore the famous Kempty Fall</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 7: Check Out and back to Delhi</strong></h2>
								...
								<div class="entry-content-tour">
									...
									<div class="custom_from">
										<div role="form" class="wpcf7" lang="en-US" dir="ltr">
											...
											<form action="6n-7d-uk.php" method="post" class="wpcf7-form"><br>
			...
			<div class="container">
				<div class="row">
					...
					<aside class="col-sm-3 custom-instagram widget_text">
						...
						<div class="textwidget">
							<ul>
								<li><img src="../images/Office/1.jpg" alt="Office" class="img-rounded"class="imgreponsive"></li>
								<li><img src="../images/Office/2.jpg" alt="Office" class="img-rounded" class="imgreponsive"></li>
								<li><img src="../images/Office/3.jpg" alt="Office" class="img-rounded" class="imgreponsive"></li>
								<li><img src="../images/Office/4.jpg" alt="Office" class="img-rounded" class="imgreponsive"></li>
								<li><img src="../images/Office/5.jpg" alt="Office" class="img-rounded" class="imgreponsive"></li>
								<li><img src="../images/Office/6.jpg" alt="Office" class="img-rounded" class="imgreponsive"></li>
							</ul>
						</div>
					</aside>
				</div>
