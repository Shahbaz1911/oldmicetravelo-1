	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(../images/banner/top-heading-himchal.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<h2 class="heading_primary">3 Nights 4 Days</h2></div>
		</div>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1: Delhi – Mussoorie (290kms/8hrs)</strong></h2>
												<p>When you reach at mussoorie our transporter will meet and greet you and then proceed to Mussoorie which is also known as Queen of hills. On reaching mussoorie check in hotel. After some rest explore the famous mall road of mussoorie. After that back to hotel. Dinner & Overnight stay in Mussoorie.</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2: Mussoorie (Local Sight Seeing)</strong></h2>
												<p>Morning take breakfast in hotel and then explore the local sight seeing of Mussoorie to Kempty Fall, after enjoying the water fall of Kempty return back to Mussoorie. Evening explores local Mussoorie which includes Gun Hill, Lal tibba, and Camel back. After that back to hotel. Dinner & overnight at hotel.</p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">3</span></p>
											<div class="item_content">
												<h2><strong>Day 3: Mussoorie - Dhanaulti - Mussoorie</strong></h2>
												<p>Morning after breakfast, take a drive to Dhanaulti and then enjoy great sightseeing covering Jain Temples, ECO-Park, Barehipani and Joranda Falls, Dashavatar Temple. Overnight at hotel in Mussorie.</p></div>
										</div>
										
									<div class="interary-item">
											<p><span class="icon-left">4</span></p>
											<div class="item_content">
												<h2><strong>Day 4: Mussoorie - Delhi(290kms/8hrs)</strong></h2>
												<p>Early after breakfast, check out the hotel. On arrival at Delhi, proceed to airport/ railway station for onward journey Tour End.</p>
											</div>
										</div>						
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-location-tab">
										...
										<iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d3572641.502212133!2d76.61048376444961!3d29.019721808905427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e0!4m5!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!3m2!1d28.7040592!2d77.10249019999999!4m5!1s0x3908d0cfa61cda5b%3A0x197fd47d980e85b1!2sMussoorie%2C+Uttarakhand!3m2!1d30.4599099!2d78.06639779999999!5e0!3m2!1sen!2sin!4v1526643200905" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
										</div>
									</div>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											...
											<td>Per Person (INR - 20,000)</td>
											<td>Per Person (INR - 12,500)</td>
											<td>Per Person (INR - 11,500)</td>											
										   </tr>
										   <tr>    
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 11,500</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
									...
									<div class="custom_from">
										<div role="form" class="wpcf7" lang="en-US" dir="ltr">
											...
											<form action="3n-4d-uk-2.php" method="post" class="wpcf7-form"><br>
