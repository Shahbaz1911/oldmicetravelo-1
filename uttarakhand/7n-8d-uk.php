								...
								<div class="tab-content">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Nanital (2 Nights) - Kausani (1 Night)- Jim Corbett(1 Night)- Haridwar (1 Night)- Mussoorie (2 Nights)</td>
											</tr>
											<tr>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 03: Nainital – Almora – Kausani (115 kms)</strong></h2>
												<p>After Breakfast check out from Hotel, Travel by surface from Nainital to Kausani vai Almora .On arrival check in at hotel. Rest of the day free for independent activities. Overnight at hotel.</p></div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">4</span></p>
											<div class="item_content">
												<h2><strong>Day 4: Check Out and Travel to Jim Corbett</strong></h2>
									...
									<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 5: Jungle safari & Driver to Haridwar </strong></h2>
												<p>Wake up at 5 AM for your morning Jungle Safari which is included in your package. Jungle Safari lasts for 3 Hours wherein you can sight Tiger, Leopard, Spotted Deer, Hyena, Fox etc. Return to your resort and get fresh. Post Breakfast check out and then we will head to Haridwar. It will take 4 hours to reach basis the traffic condition. Check-In to your assigned resort. . After fresh up visit Ram Jhula, Mansa Devi Temple, Rope way Ganga Ji kiAarti at Harki Pori. Dinner at Hotel and overnight stay. </p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">6</span></p>
											<div class="item_content">
												<h2><strong>Day 6: Driver to Mussoorie</strong></h2>
												<p>After early breakfast. Check out hotel. Depart for Mussoorie On the way visit Risikesh , Dehradun sightseeing On arrival, check in hotel. After fresh up visit Mall Road, Rope way. Dinner at hotel and overnight stay.
											</p>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 7: Explore the famous Kempty Fall</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 8: Check Out and back to Delhi</strong></h2>
...
<tr>    
										   ...
										   <tr> 										   
											...
											<td>1</td>
											<td>--</td>
											<td>Hotel The Great Ananda/Similar</td>
										   </tr>
											<tr>    
											<td>Mussoorie</td>
											<td>2</td>
