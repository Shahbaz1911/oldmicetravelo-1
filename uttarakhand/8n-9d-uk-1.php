								...
								<div class="tab-content">
										...
										<table class="tours-tabs_table">
											...
											<tr>
												...
												<td>Kathgodam  Railway Station</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>Nanital (2 Nights) - Kausani (1 Night)- Chaukori(2 Nights)- Munsyari (2 Nights)- Almora (1 Night)</td>
											</tr>
											<tr>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1: Delhi – Nainital-Nainital Sight Seeing (310kms/8hrs) </strong></h2>
												<p>Pick up from from Kathgodam to Nainital (36 kms 1 hour). Check in to the hotel and arrive to Sight seeing of Nainital. Visit to the holy Naina Devi Temple, Naina peak, Snow view (cable car), Lands End etc. evening enjoy walk on Mall Road and back in to the hotel and over Night Stay </p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 02 Nainital Lake Tour</strong></h2>
												<p>After Breakfast Arrive to the Lake tour (Bhimtal, Sattal, Nakuchiatal, Fruit Market and Bhowali) then back to Nainital one row boat ride in Naini lake then Back to the hotel, over night stay.... </p>
											</div>
										</div>
											<div class="interary-item">
											<p><span class="icon-left">3</span></p>
											<div class="item_content">
												<h2><strong>Day 03 Kausani - Kausani Sight Seeing</strong></h2>
												<p>After Breakfast Arrive to the Kausani, Via Almora Visit Bhowali, Kanchi Temple, Khairna, Almora Local Sightseeing, Check in to the Hotel See Sun Set Point from the hotel, Check in to the hotel and over Night stay at the hotel.... </p></div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">4</span></p>
											<div class="item_content">
												<h2><strong>Day 04 Kausani - Jageshwar</strong></h2>
												<p>Get up early to enjoy breathtaking views of the Himalayas (can become hazy later). Check out from the hotel arrive to Chakouri (70 kms, 2 - 3 hours) via Jageshwar. 2500 Years old Ancient temples at Jageshwar. Overnight stay at Chakouri.</p></div>
										</div>										
										
									<div class="interary-item">
											<p><span class="icon-left">5</span></p>
											<div class="item_content">
												<h2><strong>Day 05 Kausani - Chakouri </strong></h2>
												<p>Morning enjoy Himalayan views from chakouri and later visit Patal Bhubneshwar (36 kms, 1 hour). Overnight stay at Chakouri.</p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">6</span></p>
											<div class="item_content">
												<h2><strong>Day 06 - Chakouri - Munsiyari </strong></h2>
												<p>Morning Check our from the hotel and arrive to Munsiyari (100 kms, 4 hours). At Munsyari you come very close to the Himalayas . Breathtaking views all around. Check in to the hotel and Overnight stay . 
											</p>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 07 - Munsiyari</strong></h2>
												<p>After Breakfast arrive to Local sightseeing / trekking. Back in to the hotel Overnight Stay at Munsyari.</p>
											</div>
										</div>
										<div class="interary-item">
											<p><span class="icon-left">8</span></p>
											<div class="item_content">
												<h2><strong>Day 08 - Munsiyari - Almora</strong></h2>
												<p>Morning Breakfast and arrvie to almora (210 kms, 7 to 8 hours). Arrive late afternoon. Some local sightseeing or relax at the resort. Overnight stay at Almora .. </p>
											</div>
										</div>
                                        <div class="interary-item">
											<p><span class="icon-left">9</span></p>
											<div class="item_content">
												<h2><strong>Day 09 - Almora - Binsar Wildlife Sanctuary - Kathgodam</strong></h2>
												<p>Morning visit Binsar Wildlife Sanctuary and later arrive to Kathgodam for onward journey.</p>
											</div>
										</div>
...
<tr>    
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											...
											<td>Per Person (INR - 27,500)</td>
											<td>Per Person (INR - 19,500)</td>
											<td>Per Person (INR - 18,500)</td>											
										   </tr>
										   <tr>    
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 18,500</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
									...
									<div class="custom_from">
										<div role="form" class="wpcf7" lang="en-US" dir="ltr">
											...
											<form action="7n-8d-uk.php" method="post" class="wpcf7-form"><br>
