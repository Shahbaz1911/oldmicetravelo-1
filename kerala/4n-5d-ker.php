								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-hotels-tab">
										<table id="customers" >
											...
											<td>Munnar</td>
											<td>2</td>
											<td>Spice Jungle Resort</td>
											<td>Green Ridge Holiday Home/Similar</td>
										   </tr>
										    <tr>    
											<td>Thekkady</td>
											<td>1</td>
											<td>Hotel Lakeshore Inn</td>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 12,500</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
									...
									<div class="custom_from">
										<div role="form" class="wpcf7" lang="en-US" dir="ltr">
											...
											<form action="4n-5d-ker.php" method="post" class="wpcf7-form"><br>
