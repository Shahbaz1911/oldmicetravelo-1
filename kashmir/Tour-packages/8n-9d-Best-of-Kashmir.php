			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li><a href="../../kashmir/kashmir.php">Kashmir</a></li>
						<li><a href="../../kashmir/Tour-packages/5n-6d-mystique-kashmir.php">Best of Kashmir </a></li>

					</ul>
				</div>
				<h2 class="heading_primary">8 Nights 9 Days</h2></div>
		</div>
...
Arrive Delhi by morning 06:00 am.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											<img src="../../images/tour-package-price/kashmir/best-of-kashmir.png" alt="">
										...
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="4n-5d-magical-kashmir.php" rel="bookmark">Rediscover Kashmir</a>
												</h4></div>
												<span class="post_date">06 NIGHTS / 07 DAYS</span>
												<div class="description">
													<p>Srinagar (1 Night) - Pahalgam (2 Nights) - Gulmarg (1 Night) - Srinagar (2 Nights)<br><br><br></p>
												</div>
											</div>
											<div class="read_more">
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<span class="price">INR 26,250 Per person
													...
													<img width="950" height="700" src="../../images/tour/kashmir-tour/5.png" alt="Discover Himachal" title="Discover Himachal">
												</a>
												<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="7n-8d-Vaishnodevi-Darshan-Kashmir.php" rel="bookmark">Vaishnodevi Darshan with Kashmir</a>
												</h4></div>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 32,900</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
