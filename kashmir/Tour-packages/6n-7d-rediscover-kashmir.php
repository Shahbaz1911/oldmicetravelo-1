					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="../../images/tour/kashmir-tour/1 .png" class="swipebox" title=""><img width="813" height="384" src="../../images/tour/kashmir-tour/3.png" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									...
									<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 07:		DEPARTURE</strong></h2>
...
Arrive Delhi by morning 06:00 am.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											<img src="../../images/tour-package-price/kashmir/(6-7)-rediscover-kashmir.png" alt="">
							...
							<div class="related tours">
								...
								<li class="item-tour col-md-4 col-sm-6 product">
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											<div class="post_images">
												<a href="7n-8d-rediscover-kashmir.php">
											<span class="price">INR 30,250 Per person
												
											</span>
													<span class="onsale">Sale!</span>
													<img width="950" height="700" src="../../images/tour/kashmir-tour/4.png" alt="Discover Himachal" title="Discover Himachal">
												</a>
												<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="7n-8d-rediscover-kashmir.php" rel="bookmark">Rediscover Kashmir</a>
												</h4></div>
												<span class="post_date">07 NIGHTS / 08 DAYS  </span>
												<div class="description">
													<p>  Srinagar (1 Night) - Pahalgam (2 Nights) - Gulmarg
                            (1 Night) - Srinagar (3 Nights)</p>
												</div>
											</div>
											<div class="read_more">
												<div class="item_rating">
												...
												<a rel="nofollow" href="7n-8d-rediscover-kashmir.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
											</div>
										</div>
									</li>									
								</ul>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 26,250</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
