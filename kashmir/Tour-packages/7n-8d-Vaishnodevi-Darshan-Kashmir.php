			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li><a href="../../kashmir/kashmir.php">Kashmir</a></li>
						<li><a href="../../kashmir/Tour-packages/5n-6d-mystique-kashmir.php">Vaishnodevi Darshan with Kashmir </a></li>

					</ul>
				</div>
				<h2 class="heading_primary">7 Nights 8 Days</h2></div>
		</div>
					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							<div class="title-single">
								<div class="title">
									<h1>Vaishnodevi Darshan with Kashmir </h1>
								</div>
								<div class="tour_code">
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 01	:	ARRIVE – JAMMU – KATRA </strong></h2>
												<p>Arrive Jammu by Train OR by Air. Meet and assist on arrival at Railway Station or at Airport and proceed straight to Katra by Car. Arrive Katra and check in at Hotel</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 04	:	PAHALGAM</strong></h2>
												<p?>In Pahalgam. Day free to explore surrounding on own. Overnight stay at hotel</p>
</p>
											</div>
										</div>
											<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 05 :		 PAHALGAM – GULMARG    </strong></h2>
												<p>After breakfast, transfer towards Gulmarg, called as “Meadow of Flowers” Gulmarg is 150 Kms from Pahalgam at an altitude of 8700-ft. Gulmarg also referred as Meadow of Flowers is a famous Ski Resort & the world’s highest 18 hole Golf Course. The place was prominent during the British time.  Enjoy the scenic view of Kongdori on a Cable Car Ride – OPTIONAL (Gondola) Dinner & Overnight at the Hotel.
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 06 :		GULMARG – SRINAGAR + LOCAL SIGHTSEEING </strong></h2>
												<p>Transfers from Gulmarg to Srinagar. In Afternoon, visit Mughal Gardens "Nishat" (The Garden of Pleasure) and "Shalimar" (Abode of All). Drive along the Lake side on Boulevard On return visit a local Handicrafts Emporium for hand-knotted specialty silken carpets, shawls, jewellery ornaments.  Also visit Shankaracharya Temple. Evening, enjoy 01 Hour Boat Ride on Dal Lake by a gondola Boat called ”SHIKARA” witness the ride on lake, called Venice of India & experience the aquatic life of Srinagar. Also see the scenic extravaganza of the Kashmir and enjoy the profusion of colors in the Paradise on Earth. While returning visit to the local crafts market and see the fine carved hand-made articles from Paper Machie & wood of a walnut. Overnight at the Deluxe Houseboat. 
</p>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 07 :		SRINAGAR – SONAMARG - SRINAGAR  </strong></h2>
												<p>After breakfast leave with full day excursion for Sonamarg. Situated at an altitude of 9000 Ft. Sonamarg – 84 Kms is also called as “The meadow of gold” has, as its backdrop, snowy mountains against a cerulean sky. The Sindh River that meanders through the valley abounds with trout and mahaseer. Ponies can be hired for the trip up to Thajiwas glacier, which is a major local attraction during the summer. Return for Dinner & overnight stay HB / Hotel.
</p>
											</div>
										</div>
									...
									<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>DAY 08:		DEPARTURE</strong></h2>
												<p>Departure at Srinagar Airport to connect the flight for onwards destination. TOUR ENDS WITH SWEET MEMORIES!</p>
											</div>
										</div>
										<!-- <div class="interary-item">
											<p><span class="icon-left">5</span></p>
...
Arrive Delhi by morning 06:00 am.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											<img src="../../images/tour-package-price/kashmir/Vaishnodevi-kashmir.png" alt="">
								...
								<li class="item-tour col-md-4 col-sm-6 product">
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="5n-6d-explore-kashmir.php" rel="bookmark">Explore Kashmir</a>
												</h4></div>
												<span class="post_date">5 NIGHTS 6 DAYS</span>
												<div class="description">
													<p>Srinagar (1 Night) - Pahalgam (1 Night) - Srinagar (3 Nights)<br><br><br></p>
												</div>
											</div>
											<div class="read_more">
												<div class="item_rating">
												...
												<a rel="nofollow" href="5n-6d-explore-kashmir.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
											</div>
										</div>
									</li>
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											<div class="post_images">
												<a href="7n-8d-Vaishnodevi-Darshan-Kashmir.php">
											<span class="price">INR 26,250 Per person
												
											</span>
													<span class="onsale">Sale!</span>
													<img width="950" height="700" src="../../images/tour/kashmir-tour/6.png" alt="Discover Himachal" title="Discover Himachal">
												</a>
												<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="7n-8d-Vaishnodevi-Darshan-Kashmir.php" rel="bookmark">Best of Kashmir</a>
												</h4></div>
												<span class="post_date">08 NIGHTS / 09 DAYS  </span>
												<div class="description">
													<p> Srinagar (1 Nights) - Pahalgam (2 Nights) - Gulmerg (2 Nights) - Srinagar (3 Nights)</p>
												</div>
											</div>
											<div class="read_more">
												<div class="item_rating">
												...
												<a rel="nofollow" href="7n-8d-Vaishnodevi-Darshan-Kashmir.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
											</div>
										</div>
									</li>									
								</ul>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 30,100</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
