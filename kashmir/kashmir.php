...
<html lang="en-US">
  <head>
    ...
    <meta
      name="description"
      content="Award winning travel agency in India offering deals on India tour packages. Travel to India with our India travel guide and customized tour packages."
    />
    <meta
      name="keywords"
      content="India Travel, Travel to India, India Tour, Indian holiday,Indian holidays,India Holiday,India Tour and Travel, India Tour Agent,Travel To India Tours"
    />
    ...
    <link
      rel="stylesheet"
      href="../assets/new-fonts/flaticon.css"
      type="text/css"
      media="all"
    />
    <link
      rel="stylesheet"
      href="../assets/css/font-linearicons.css"
      type="text/css"
      media="all"
    />
    <link
    ...
    <link
      rel="stylesheet"
      href="../assets/css/travel-setting.css"
      type="text/css"
      media="all"
    />
    <link
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-122966679-1"
    ></script>
    <script>
    ...
    <script type="text/javascript">
      window.$zopim ||
        (function (d, s) {
          ...
          $.src = "https://v2.zopim.com/?4yfkcxDv0jCG8bXJieOVTVqRmTgMZYqm";
          z.t = +new Date();
    ...
    <div class="wrapper-container">
      <header id="masthead" class="site-header sticky_header affix-top">
                ...
                <aside id="text-15" class="widget_text">
                  <div class="textwidget">
                    <ul class="top_bar_info clearfix">
                      <li>
                        <i class="fa fa-clock-o"></i>Mon - Sat 10.00 AM - 06.00
                        PM. Sunday Closed
                      </li>
                    </ul>
                  </div>
        ...
        <div class="navigation-menu">
          <div class="container">
            <div
              class="menu-mobile-effect navbar-toggle button-collapse"
            ...
            <div class="width-logo sm-logo">
              <a href="../index.php" title="Travel" rel="home">
                <img
                  src="../images/Full Logo with 9fame.png"
                  alt="Logo"
                  width="147"
                  height="58"
                ...
                />
                <img
                  src="../images/Full Logo-sticky.png"
                  alt="Sticky logo"
                  width="147"
                  height="58"
                  class="logo_sticky"
            ...
            <nav class="width-navigation">
              <ul
                class="nav navbar-nav menu-main-menu side-nav"
                id="mobile-demo"
              >
                <li>
                ...
                <li class="current-menu-ancestor current-menu-parent">
                  ...
                  <ul class="sub-menu">
                    <li>
                      <a href="../himachal/himachal.php">Himachal Pradesh</a>
                    </li>
                    <li>
                      <a href="../uttarakhand/uttarakhand.php">Uttarakhand</a>
                    </li>
                ...
                <li class="menu-right">
                  <ul>
                    <li
                      id="travel_social_widget-2"
                      class="widget travel_search"
                    >
                      ...
                      <div class="search-menu search-overlay search-hidden">
                        ...
                        <form method="get" class="search-form" action="#">
                          ...
                          <input
                            type="submit"
                            class="search-submit font-awesome"
                            value="&#xf002;"
                          />
                        </form>
      ...
      <div class="site wrapper-content">
        <div
          class="top_site_main"
          style="
            background-image: url(../images/banner/top-heading-himchal.jpg);
          "
        >
          <div class="banner-wrapper container article_heading">
            ...
            <h1 class="heading_primary">Kashmir Tour Packages</h1>
          </div>
        </div>
              ...
              <div class="site-main col-sm-9 alignright">
                <ul class="tours products wrapper-tours-slider">
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      <div class="post_images">
                        <a href="Tour-packages/3n-4d-kashmir-bliss.php">
                        ...
                        <div class="group-icon">
                          ...
                          <a
                            ...
                            data-placement="top"
                            title=""
                            data-original-title="Private Cab"
                          ...
                          <a
                            ...
                            data-placement="top"
                            title=""
                            data-original-title="Sightseeing"
                      ...
                      <div class="wrapper_content">
                        <div class="post_title">
                          <h4>
                            <a
                              href="Tour-packages/3n-4d-kashmir-bliss.php"
                              rel="bookmark"
                              >Kashmir Bliss</a
                            >
                          </h4>
                  ...
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      <div class="post_images">
                        <a href="Tour-packages/4n-5d-magical-kashmir.php">
                          <span class="price">
                            <ins>INR 17,950 Per Person</ins>
                          </span>
                      ...
                      <div class="wrapper_content">
                        <div class="post_title">
                          <h4>
                            <a
                              href="Tour-packages/4n-5d-magical-kashmir.php"
                              rel="bookmark"
                              >Magical Kashmir</a
                            >
                          </h4>
                  ...
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      <div class="post_images">
                        <a href="Tour-packages/5n-6d-explore-kashmir.php">
                          <span class="price">
                            <ins> INR 21,450 Per Person</ins>
                          </span>
                          <span class="onsale">Sale!</span>
                          <img
                            width="430"
                      ...
                      <div class="wrapper_content">
                        <div class="post_title">
                          <h4>
                            <a href="Tour-packages/5n-6d-explore-kashmir.php" rel="bookmark"
                              >Explore Kashmir</a
                            >
                          </h4>
                        </div>
                        ...
                        <div class="description">
                          <p>
                            Srinagar (1 Night) - Pahalgam (1 Night) - Srinagar
                            (3 Nights)
                          </p>
                        </div>
                      </div>
                      <div class="read_more">
                        ...
                        <a
                          rel="nofollow"
                          href="Tour-packages/5n-6d-explore-kashmir.php"
                          class="button product_type_tour_phys add_to_cart_button"
                          >Read more</a
                        >
                      </div>
                  ...
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      <div class="post_images">
                        <a href="Tour-packages/5n-6d-mystique-kashmir.php">
                          <span class="price">INR 22,750 Per Person</span>
                          <img
                            width="430"
                            height="305"
                      ...
                      <div class="wrapper_content">
                        <div class="post_title">
                          <h4>
                            <a href="Tour-packages/5n-6d-mystique-kashmir.php" rel="bookmark"
                              >Mystique Kashmir</a
                            >
                          </h4>
                        </div>
                        ...
                        <div class="description">
                          <p>
                            Srinagar (1 Night) - Pahalgam (1 Night) - Gulmarg (1
                            Night) - Srinagar (2 Nights)
                          </p>
                        </div>
                      </div>
                      <div class="read_more">
                        ...
                        <a
                          rel="nofollow"
                          href="Tour-packages/5n-6d-mystique-kashmir.php"
                          class="button product_type_tour_phys add_to_cart_button"
                          >Read more</a
                        >
                      </div>
                  ...
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      ...
                      <div class="wrapper_content">
                        ...
                        <div class="description">
                          <p>
                            Katra (2 Nights) - Pahalgam (2 Nights) - Gulmarg (1
                            Night) - Srinagar (1 Night) - Srinagar (1 Night)
                          </p>
                        </div>
                      </div>
                      <div class="read_more">
                  ...
                  <li class="item-tour col-md-6 col-sm-6 product">
                    <div class="item_border item-product">
                      ...
                      <div class="wrapper_content">
                        ...
                        <span class="post_date">08 NIGHTS / 09 DAYS </span>
                        <div class="description">
                          <p>
                            Srinagar (1 Nights) - Pahalgam (2 Nights) - Gulmerg
                            (2 Nights) - Srinagar (3 Nights)
                          </p>
                        </div>
                      </div>
                      <div class="read_more">
                    ...
                    <div class="inner-special-tours">
                      <a href="../kashmir/kashmir.php">
                        <img
                          width="430"
                          height="305"
                          src="../images/tour/kashmir-tour/tour-1.jpg"
                          alt="Discover Himachal"
                          title="Discover Himachal"
                      /></a>
                      <div class="item_rating">
                      ...
                      <div class="post_title">
                        <h3>
                          <a href="../kashmir/kashmir.php" rel="bookmark"
                            >Kashmir</a
                          >
                        </h3>
                      </div>
                      <div class="item_price">
                        <span class="price">INR 15,250 PP</span>
                      </div>
                    </div>
                    <div class="inner-special-tours">
                      <a href="../kerala/kerala.php">
                        ...
                        <img
                          width="430"
                          height="305"
                          src="../images/tour/himachal-tour/tour-2.jpg"
                          alt="Discover Himachal"
                          title="Discover Himachal"
                      /></a>
                      <div class="item_rating">
                      ...
                      <div class="post_title">
                        <h3>
                          <a href="../kerala/kerala.php" rel="bookmark"
                            >Somnath</a
                          >
                        </h3>
                      </div>
                    ...
                    <div class="inner-special-tours">
                      <a href="../uttarakhand/uttarakhand.php">
                        <img
                          width="430"
                          height="305"
                          src="../images/tour/uttarakhand-tour/tour-3.jpg"
                          alt="Discover Himachal"
                          title="Discover Himachal"
                        />
                      </a>
                      ...
                      <div class="post_title">
                        <h3>
                          <a
                            href="../uttarakhand/uttarakhand.php"
                            rel="bookmark"
                            >Uttarakhand</a
                          >
                        </h3>
      ...
      <div class="wrapper-footer wrapper-footer-newsletter">
              ...
              <aside class="col-sm-3 widget_text">
                ...
                <div class="textwidget">
                  <div class="footer-info">
                    <p><b>Mice Travelo Expert Pvt.Ltd.</b></p>
                    <ul class="contact-info">
                      <li>
                        <i class="fa fa-map-marker fa-fw"></i>Delhi Office: 285,
                        2nd Floor, Vardhman Grand Plaza Manglam Place, Sec 3
                      ...
                      <li>
                        ...
                        ><a href="mailto:info@micetravelo.com"
                          >info@micetravelo.com</a
                        >
                      </li>
                    </ul>
                  </div>
        ...
        <div class="container wrapper-copyright">
          <div class="row">
            <div class="col-sm-6">
              <div>
                <p>Copyright © 2018 Mice Travelo. All Rights Reserved.</p>
              </div>
            </div>
            <div class="col-sm-6">
      ...
      <div
        class="wrapper-subscribe"
        style="background-image: url(../images/home/bg_newletter.jpg)"
      >
        <div class="subscribe_shadow"></div>
        <div
          class="form-subscribe parallax-section stick-to-bottom form-subscribe-full-width"
        >
          <div
            class="shortcode_title text-white title-center title-decoration-bottom-center margin-bottom-3x"
          >
          ...
          <div class="form-subscribe-form-wrap">
            <aside class="mailchimp-container">
              <form
                class="epm-sign-up-form"
                name="epm-sign-up-form"
                action="#"
                method="post"
              >
                ...
                <input
                  type="submit"
                  name="epm-submit-chimp"
                  value="Sign Up Now"
                  data-wait-text="Please wait..."
                  tabindex="10"
                  class="button btn epm-sign-up-button epm-submit-chimp"
                />
              </form>
            </aside>
          </div>
