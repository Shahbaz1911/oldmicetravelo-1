									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										<div class="interary-item">
											...
											<div class="item_content">
												...
												<p>Board your flight/ Train as per the schedule and arrive in Cochin and To Munnar. On The way visit Kalady Temple (Pick up At Air Port),Cheeyapara & Vallara waterfalls. Check into the hotel .Evening visit Blossom garden. Overnight stay @ Munnar</p>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 03 : Munnar To Thekkady</strong></h2>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 04 : Thekkady To Alleppey</strong></h2>
...
<tr>    
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											...
											<td>Per Person (INR - 12,200)</td>
										    <td>Per Person (INR -  9,500)</td>
											<td>Per Person (INR -  8,900)</td>
											<td>Per Person (INR -  8,200)</td>
											
											</tr>
											<tr> 
											<td>Deluxe Hotels</td>
											<td>Per Person (INR - 12,900)</td>
										    <td>Per Person (INR -  9,800)</td>
										   ...
										   <tr>   
											...
											<td>Per Person (INR - 14,950)</td>
										    <td>Per Person (INR - 12,100)</td>
											<td>Per Person (INR - 11,650)</td>
											<td>Per Person (INR - 10,950)</td>											
										   </tr>
											<tr>    
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 8,900</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
