								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary-tab">
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 06 : Cochin Drop</strong></h2>
...
<tr>    
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
										    ...
										    <td>Per Person (INR -  10,350)</td>
											<td>Per Person (INR -  9,750)</td>
											<td>Per Person (INR -  9,100)</td>
											
											</tr>
											<tr> 
											<td>Deluxe Hotels</td>
											<td>Per Person (INR - 13,750)</td>
										    <td>Per Person (INR - 10,900)</td>
											<td>Per Person (INR -  10,300)</td>
											<td>Per Person (INR -  9,600)</td>
																					
										   </tr>
										   <tr>   
											<td>Premium Hotels</td>
											<td>Per Person (INR - 16,600)</td>
										    <td>Per Person (INR - 13,750)</td>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount">INR 9,750</span> <span class="text">Per Person</span>
									</p>
									<div class="clear"></div>
									<!-- <div class="booking">
										<div class="">
